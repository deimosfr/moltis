...
[providers]
offered = ["local-llm", "github-copilot", "openai-codex", "openai", "anthropic", "gemini", "groq", "xai", "deepseek", "mistral", "openrouter", "ollama", "moonshot", "minimax", "zai", "cerebras", "venice", "kimi-code"] # Enabled providers and those shown in onboarding/picker UI ([] = enable/show all)
